...
namespace DVLD_DataAccessLayer
{
    public class clsDetainedLicenseData
    {
        ...
        public static bool UpdateDetainedLicense(int DetainID, int LicenseID, DateTime DetainDate, double FineFees,
                int CreatedByUserID)
        {
            int rowsAffected = 0;
        ...
        public static bool GetDetainedLicenseByLicenseID(ref int DetainID, int LicenseID, ref DateTime DetainDate, ref double FineFees,
        ...
        public static DataTable GetAllDetainedLicensesForList()
        {
            DataTable dt = new DataTable();
